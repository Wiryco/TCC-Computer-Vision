...
\input{6-Desenvolvimento-Projeto/riscos-restricoes-do-projeto.tex}

\input{6-Desenvolvimento-Projeto/requisitos.tex}

\input{6-Desenvolvimento-Projeto/explicacao-codigo.tex}

\input{6-Desenvolvimento-Projeto/testes-do-software.tex}

\input{6-Desenvolvimento-Projeto/analise-resultados.tex}